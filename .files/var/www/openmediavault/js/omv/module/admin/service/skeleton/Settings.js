...
Ext.define("OMV.module.admin.service.@@LOWERCASE_NAME@@.Settings", {
...
OMV.WorkspaceManager.registerPanel({
    id        : "settings",
    path      : "/service/@@LOWERCASE_NAME@@",
    text      : _("Settings"),
    position  : 10,
    className : "OMV.module.admin.service.@@LOWERCASE_NAME@@.Settings"
});
